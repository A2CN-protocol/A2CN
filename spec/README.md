...
(`transaction-record-0.2.schema.json`, `transaction-record-0.3.schema.json`,
`session-evidence-record-0.2.schema.json`, `session-evidence-record-0.3.schema.json`);
