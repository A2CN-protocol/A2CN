...
| OQ-017 | Post-commitment lifecycle messages | Open | Should A2CN define normative DELIVERY_NOTICE and DELIVERY_ACKNOWLEDGED message types for delivery confirmation, or leave post-commitment lifecycle to the settlement layer (AP2/ACP)? Proposed: define in v0.3 as optional messages for Level 3 conformance. Rationale: closes the gap between agreement and payment, enables DISPUTE_NOTICE anchoring to the transaction record, and supports Meeting Place dispute resolution workflows. |
